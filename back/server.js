...
//Si quisieramos que el front se sirviera desde el mismo servidor, descomentar la siguiente línea

//app.use('/cart', express.static(path.join(__dirname, '../front-cart')));
//app.use('/cart-bootstrap', express.static(path.join(__dirname, '../front-cart-bootstrap')));
//app.use('/crud', express.static(path.join(__dirname, '../front-crud')));
//app.use('/crud-bootstrap', express.static(path.join(__dirname, '../front-crud-bootstrap')));
